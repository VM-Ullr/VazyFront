    ...
    <b-container fluid>
      <b-row>
        ...
        <b-col class="col2">
          ...
          <div class="roundContainer">
            Trouvé sur le web:
            <div class="roundContainer" v-for="item in post.foundAt" :key="item.id">
              <a :href='item.urlImg'>Cette oeuvre</a> est présente sur le site <a :href='item.urlSite'>{{item.urlSite}}</a>
            </div>
          </div>
